# AWS VPC Module for Multi-Cloud QR Code Generator
...
resource "aws_route_table" "private" {
  ...
  tags = merge(var.tags, {
    Name = var.enable_nat_gateway ? "${local.name}-private-rt-${var.availability_zones[count.index]}" : "${local.name}-private-rt"
    Type = "private"
  })
}
